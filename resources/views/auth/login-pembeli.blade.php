            ...
            <div class="row align-items-center g-5" style="min-height: 86vh;">
                <div class="col-12">
                    <div class="d-flex justify-content-center gap-4">
                        <a href="{{ route('login', 'as=pembeli') }}" class="btn btn-primary px-5">Pembeli</a>
                        <a href="{{ route('login', 'as=penjual') }}" class="btn btn-light px-5">Penjual</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="w-75 mx-auto">
                        <h1 class="text-center fw-bold mb-5">Login</h1>
                        <form action="{{ route('login', 'as=pembeli') }}" method="POST">
                            @csrf
                            <div class="mb-4">
                ...
                <div class="col-md-6 d-none d-lg-block">
                    <div class="sect-right">
                        ...
                        <a href="{{ route('register', 'as=pembeli') }}" class="btn btn-light btn-lg fw-bold px-5">Sign
                            Up</a>
                    </div>
                </div>
            </div>
