                    ...
                    <div class="col-md-4">
                        <div class="card rounded-5 overflow-hidden p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Harga<br>
                                    Rp. {{ number_format($product->auction->starting_price, '0', '0', '.') }}
                                </p>
                            </div>
                            <div class="card-footer border-0 bg-transparent">
                                <a href="{{ route('lelang.show', $product->slug) }}"
                                    class="btn btn-primary btn-lg w-100 rounded-4">Ajukan Penawaran</a>
                            </div>
                        </div>
                    </div>
                @endforeach
